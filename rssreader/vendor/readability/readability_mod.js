...
var readability = {
    ...
    window: null, //#modified for my use
    document: null, //#modified for my use
    ...
    parse: function(win) {
    	readability.window = win;
    	readability.document = win.document; //#modified for my use
    	
        /* Before we do anything, remove all scripts that are not readability. */
    	readability.window.onload = readability.window.onunload = function() {};

        readability.removeScripts(readability.document);

        if(readability.document.body && !readability.bodyCache) {
            readability.bodyCache = readability.document.body.innerHTML;

        }
        /* Make sure this document is added to the list of parsed pages first, so we don't double up on the first page */
        readability.parsedPages[readability.window.location.href.replace(/\/$/, '')] = true;

        /* Pull out any possible next page link first */
        //var nextPageLink = readability.findNextPageLink(readability.document.body);
        
        readability.prepDocument();

        /* Build readability's DOM tree */
        //#commented out for my use
        //var overlay        = readability.document.createElement("DIV");
        //var innerDiv       = readability.document.createElement("DIV");
        ...
        //var articleFooter  = readability.getArticleFooter(); //#commented out for my use
        
        return {title:articleTitle, content:articleContent,}; //#for my use
        
//# commented out for my use        
//        if(!articleContent) {
//            articleContent    = readability.document.createElement("DIV");
...
//        readability.document.body.className = readStyle;
//        readability.document.dir            = readability.getSuggestedDirection(articleTitle.innerHTML);
//
...
//         readability.document.body.innerHTML = "";
//         readability.document.body.insertBefore(overlay, readability.document.body.firstChild);
//         readability.document.body.removeAttribute('style');
//
//        if(readability.frameHack)
//        {
//            var readOverlay = readability.document.getElementById('readOverlay');
...
//        **/
//        if((readability.window.location.protocol + "//" + readability.window.location.host + "/") === readability.window.location.href)
//        {
//            articleContent.style.display = "none";
//            var rootWarning = readability.document.createElement('p');
...
//
//        readability.window.scrollTo(0, 0);
//
...
//            **/
//        	readability.window.setTimeout(function() {
//                readability.appendNextPage(nextPageLink);
//            }, 500);
//        }
//
//        /** Smooth scrolling **/
//        readability.document.onkeydown = function(e) {
//            var code = (readability.window.event) ? event.keyCode : e.keyCode;
//            if (code === 16) {
...
//                var windowHeight = readability.window.innerHeight ? readability.window.innerHeight : (readability.document.documentElement.clientHeight ? readability.document.documentElement.clientHeight : readability.document.body.clientHeight);
//
...
//        };
//        
//        readability.document.onkeyup = function(e) {
//            var code = (readability.window.event) ? event.keyCode : e.keyCode;
//            if (code === 16) {
...
//        if(readability.convertLinksToFootnotes && !readability.window.location.href.match(/wikipedia\.org/g)) {
...
//        var articleTools = readability.document.createElement("DIV");
//
...
//#######
    ...
    getArticleTitle: function () {
        ...
        try {
            curTitle = origTitle = readability.document.title;
            
            if(typeof curTitle !== "string") { /* If they had an element with id "title" in their HTML */
                curTitle = origTitle = readability.getInnerText(readability.document.getElementsByTagName('title')[0]);             
            }
        }
        catch(e) {}
        ...
        {
            var hOnes = readability.document.getElementsByTagName('h1');
            if(hOnes.length === 1)
            {
        ...
        //# commented out for my use
        //var articleTitle = readability.document.createElement("H1");
        //articleTitle.innerHTML = curTitle;
        
        //return articleTitle;
        
        return curTitle; //#modified for my use
    },
...
//        var articleFooter = readability.document.createElement("DIV");
//        articleFooter.id = "readFooter";
//        articleFooter.innerHTML = [
//        "<div id='rdb-footer-print'>Excerpted from <cite>" + readability.document.title + "</cite><br />" + readability.window.location.href + "</div>",
...
//    },
    ...
    prepDocument: function () {
         ...
         */
        if(readability.document.body === null)
        {
            var body = readability.document.createElement("body");
            try {
            	readability.document.body = body;       
            }
            catch(e) {
            	readability.document.documentElement.appendChild(body);
                dbg(e);
            }
        }

        readability.document.body.id = "readabilityBody";

        var frames = readability.document.getElementsByTagName('frame');
        if(frames.length > 0)
        {
            var bestFrame = null;
            ...
            if(bestFrame)
            {
                var newBody = readability.document.createElement('body');
                newBody.innerHTML = bestFrame.contentWindow.document.body.innerHTML;
                newBody.style.overflow = 'scroll';
                readability.document.body = newBody;
                
                var frameset = readability.document.getElementsByTagName('frameset')[0];
                if(frameset) {
        ...
        for (var k=0;k < readability.document.styleSheets.length; k+=1) {
            if (readability.document.styleSheets[k].href !== null && readability.document.styleSheets[k].href.lastIndexOf("readability") === -1) {
            	readability.document.styleSheets[k].disabled = true;
            }
        }

        /* Remove all style tags in head (not doing this on IE) - TODO: Why not? */
        var styleTags = readability.document.getElementsByTagName("style");
        ...
        readability.document.body.innerHTML = readability.document.body.innerHTML.replace(readability.regexps.replaceBrs, '</p><p>').replace(readability.regexps.replaceFonts, '<$1span>');
    },
...
//        var footnotesWrapper = readability.document.getElementById('readability-footnotes'),
//            articleFootnotes = readability.document.getElementById('readability-footnotes-list');
//        
//        if(!footnotesWrapper) {
//            footnotesWrapper               = readability.document.createElement("DIV");
...
//            
//            articleFootnotes    = readability.document.createElement('ol');
//            articleFootnotes.id = 'readability-footnotes-list';
//            
//            footnotesWrapper.appendChild(articleFootnotes);
//    
//            var readFooter = readability.document.getElementById('readFooter');
//            
//            if(readFooter) {
...
//                refLink      = readability.document.createElement('a'),
//                footnote     = readability.document.createElement('li'),
//                linkDomain   = footnoteLink.host ? footnoteLink.host : readability.document.location.host,
...
//        var rdbHead      = readability.document.getElementsByTagName('head')[0];
//        var rdbTKScript  = readability.document.createElement('script');
//        var rdbTKCode    = null;
//
//        var rdbTKLink    = readability.document.createElement('a');
...
//            readability.document.getElementById("rdb-footer-right").appendChild(rdbTKLink);
//        }
...
//                    dbg("Caught typekit");
//                    Typekit.load();
//                    clearInterval(readability.window.typekitInterval);
//                } catch(e) {
//                    dbg("Typekit error: " + e);
//                }
//            }
//        };
//
//        readability.window.typekitInterval = readability.window.setInterval(typekitLoader, 100);
//    },
    ...
    **/
    grabArticle: function (page) {
        ...
        page = page ? page : readability.document.body;
        ...
        for(var nodeIndex = 0; (node = allElements[nodeIndex]); nodeIndex+=1) {
            ...
            if (node.tagName === "DIV") {
                if (node.innerHTML.search(readability.regexps.divToPElements) === -1) {
                    var newNode = readability.document.createElement('p');
                    try {
                ...
                else
                {
                    ...
                    for(var i = 0, il = node.childNodes.length; i < il; i+=1) {
                        ...
                        if(childNode.nodeType === 3) { // Node.TEXT_NODE
                            var p = readability.document.createElement('p');
        ...
        **/
        ...
        {
            topCandidate = readability.document.createElement("DIV");
        ...
        **/
        var articleContent        = readability.document.createElement("DIV");
        if (isPaging) {
            articleContent.id     = "readability-content";
        }
            ...
            **/
            ...
            if(append) {
                ...
                if(siblingNode.nodeName !== "DIV" && siblingNode.nodeName !== "P") {
                    ...
                    nodeToAppend = readability.document.createElement("DIV");
                    try {
        ...
        **/
        ...
        if(readability.getInnerText(articleContent, false).length < 150) {
...
//        var noUrlParams     = readability.window.location.pathname.split("?")[0],
...
//        return readability.window.location.protocol + "//" + readability.window.location.host + cleanedSegments.reverse().join("/");
//    },
//
//    /**
...
//            if(linkHref === "" || linkHref === articleBaseUrl || linkHref === readability.window.location.href || linkHref in readability.parsedPages) {
//                continue;
//            }
//            
//            /* If it's on a different domain, skip it. */
//            if(readability.window.location.host !== linkHref.split(/\/+/g)[1]) {
//                continue;
//            }
//            
...
//    **/
//    xhr: function () {
//        if (typeof XMLHttpRequest !== 'undefined' && (readability.window.location.protocol !== 'file:' || !readability.window.ActiveXObject)) {
...
//
//        var articlePage       = readability.document.createElement("DIV");
...
//
//        readability.document.getElementById("readability-content").appendChild(articlePage);
//
...
//                    var page = readability.document.createElement("DIV");
//
//                    /**
...
//                            var rPage = readability.document.getElementById('readability-page-' + i);
...
//
//        if(setScroll) {
//            return readability.window.scrollTo(0, scroll);
//        }
//        if(typeof readability.window.pageYOffset !== 'undefined') {
//            return readability.window.pageYOffset;
//        }
//        else if(readability.document.documentElement.clientHeight) {
//            return readability.document.documentElement.scrollTop;
//        }
//        else {
//            return readability.document.body.scrollTop;
//        }
//    },
//    
//    /**
